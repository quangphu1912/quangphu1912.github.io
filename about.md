...
<section class="about-band about-intro">
  <div class="about-band__inner">
...
<section class="about-band about-band--tint">
  <div class="about-band__inner">
...
<section class="about-band about-band--tint">
  <div class="about-band__inner">
    ...
    <ul class="credentials-list">
      ...
      <li>
        <span class="cred-name">MBA, Finance &amp; Consulting</span>
        <span class="cred-meta">University of Missouri</span>
      </li>
      <li>
...
<section class="about-band">
  <div class="about-band__inner">
    ...
    <ul class="currently-list">
      ...
      <li>LLM tooling and CLI-assisted development</li>
    </ul>
  </div>
</section>

<section class="about-band about-band--tint">
  <div class="about-band__inner about-contact">
